---
title: "Security in Software Applications 25/26"
collection: teaching
type: "Master Degree in CS/Cybersecurity"
...
As a replacement for Google Classroom, results will be published on this page.
...
The project, whose text can also be found here [here](https://danielefriolo.github.io/files/project.zip), can be submitted either with Google Classroom (if you are logged) or with my e-mail friolo (et) di (dot) uniroma1 (dot) it.
