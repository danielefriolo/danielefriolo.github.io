...
The project, whose text can also be found here [here](https://danielefriolo.github.io/files/project.zip), can be submitted either with Google Classroom (if you are logged) or with my e-mail friolo (dot) di (et) uniroma1 (dot) it.
